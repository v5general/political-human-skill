...
**一个 AI 政治人格建模框架 —— 重建人格结构，而非模仿标签。**

这不是观点模拟器，不是角色扮演工具，也不是普通角色卡——它造出来的是一个**职业是政治的完整的人**：
...
`Political Human Skill` 重建人格结构而非模仿标签——政治行为从人格、经历与环境中涌现。它不是历史人物复刻器，也不是立场模拟器。它把一个政治人物拆成两层，并刻意写出两层之间的冲突：
...
- 模式 A、C 产出虚构现代政治人物，模式 B 产出三级推断标注人格。
...
**信长**：（转过身来。眼睛有点红——三天没睡够四个小时）他们怕我。三个议案里两个是借票堆出来的，里面塞了和他们选区无关的条款。明天我不防守——揪着那个有问题的条款在委员会里一个一个地问。撕开这口气，另外两个不攻自破。（把笔扔到桌上，没扔准，滚到地上。他没捡）告诉改革团：我不扔下自己人。
...
| **使用的工具** | 委员会质询、预算表、选区条款 | 人事轮调、程序控制、对方内裂 | 信任动议、记名投票、全国直播 |
