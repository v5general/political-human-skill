...
>
> 与现有 `persona.yaml` 的关系：本示例的核心人格方向（现实主义 / 秩序重建 / 控制力 / 人才敏感 / 务实 / 治理型理想）与下列史料方向一致。本报告补齐证据链，使该示例成为"方法论可复现"的样例。
...
- "**奉天子以令不臣**"（迎汉献帝都许，借汉室法理制高点号令诸侯）：毛玠 192 年建议的原本表述是"奉天子以令不臣，脩耕殖以畜军资"（《三国志·毛玠传》），意为"侍奉天子以号令不臣"。**注意**：后世流传的"挟天子以令诸侯"（挟持天子以号令诸侯）是**对手方的敌意表述**（如袁绍阵营），语气更负面；正史中的内部表述是较中性的"奉天子"。两者指同一史实，但措辞差异反映立场。本 persona 取正史内部表述"奉天子"，避免使用对手方敌意措辞。借皇权法理正当性增强自身政治号召力。[#1][#2][#3]
...
- 同时代品评：许劭评"治世之能臣，乱世之奸雄"（治世能臣、乱世奸雄——同一人的两面，且"奸雄"一词本意是"非常之雄"，非后世"奸诈"义）。陈寿《三国志》评其为"非常之人，超世之杰"，强调其"卓越的智慧、明察与举贤任能"。**注意：陈寿原文不使用"秩序重建者"框架——这是 20 世纪鲁迅/毛泽东/易中天等再评价运动的现代标签**（见 §4 末条）。[#1][#3]
- 未称帝：生前最高为魏王、丞相，奉汉帝而未篡位；其子曹丕代汉建魏后追尊其为魏武帝（武帝为追谥，非生前）。[#1][#2][#3]

## 4. Mainstream Historical Interpretations

主流史学解释 / 被多个可靠来源支持的评价。保留共识，但注明这是"解释"而非"史实"。

> ⚠️ **本节分层呈现**：(a) 古代史料（陈寿 / 司马光）的原本评价；(b) 现代（20 世纪以来）再评价运动形成的"秩序重建者"框架——后者是 persona 现代化推演的合法依据，但**不等于陈寿本人对曹操的描述**。两者不可混同。后世政治评价标签（"枭雄""奸雄""秩序重建者"）保留在本节作为历史评价参照，不可作为 `personality_archetype` / `human_core` 等人格字段的描述语（见 `safety/archetype_conversion_protocol.md` §2.3）。

**古代史料的原本评价**：
- 陈寿《三国志》："非常之人，超世之杰"——强调其"卓越的智慧、明察与举贤任能"，**未使用"秩序重建"框架**。
- 司马光《资治通鉴》：肯定其"唯才用人、知人善任"，同时批评其"用法严苛"。
- 唐太宗李世民：军事才能评价高，但认为其不适合为君。
...
inferred_temperamental_pattern:
  risk_tolerance:
    ...
    note: >
      非盲目冒险型。官渡、乌桓显示其敢在算清账后承受高风险；赤壁之战（208）的失败
      现代研究（Wikipedia、de Crespigny）归因于**后勤过度延伸 + 军中疫病 + 不熟悉南方
      气候地形**，而非单纯的心理性"傲慢/急躁"——这一史源订正很重要，避免把"赤壁=人格
      缺陷"的传统叙事当作史实。整体仍是"算计后的风险承受"，非赌徒型 high。故评 medium-high
      而非 high。
  patience:
    value: medium
    confidence: medium-high
    evidence_basis:
      - documented_behavior   # 官渡对峙期表现出战略耐心；赤壁南下也有战略计算，不可简单归为"急于求成"
  ...
  trust_threshold:
    ...
    evidence_basis:
      # 史源分层（避免不同信源混同）：
      # (a) 《三国志》本文（高置信）：杀孔融 208、董承集团 200、伏皇后家族 214、杨修 219 等政治清洗
      - documented_behavior   # 正史本文中的多次政治清洗——核心证据
      # (b) 裴松之注引中性/魏方史料（中置信）：部分清洗细节、人事控制
      - repeated_pattern      # 跨情境反复：用人重才却用人盯人、对二心或潜在威胁先发处置
      # (c) 《曹瞒传》等敌意史料（低置信，de Crespigny 明确称为 "hostile propaganda"）：
      #     杀侍妾、杀盖被仆人、杀匈奴使者等戏剧化 anecdote
      # (d) 《世说新语》（5 世纪 anecdotal，非政治史）：梦中杀人等故事原型
      # 本字段主要基于 (a) + (b)；(c)(d) 仅作风格参考，不进入核心证据。
      - disputed_but_useful_for_fiction  # 部分演义"宁我负人"渲染（与正史原文方向一致，但措辞被放大）
    note: >
      信任是慢变量，且建立后仍持续监控。这是其最显著的气质特征之一。
      注意：low 是对"背叛 / 失控信号"的低阈值反应（基于正史政治清洗的稳定模式）；
      但部分戏剧化 anecdote（杀侍妾、梦中杀人）来自《曹瞒传》等敌意史料（de Crespigny
      明确称为 "hostile propaganda"），不应同等对待——本 persona 取核心政治行为模式，
      不取敌意史料中的极端细节作为人格定义。
  ambition_level:
    value: high
    confidence: medium-high
...
> 一句话：本报告证明 `cao_cao_modernized` 的核心人格方向（现实主义 / 秩序重建 / 控制力 / 人才敏感 / 务实 / 治理型理想）可由正史 + 学术史料复现——不是手工写死的。
