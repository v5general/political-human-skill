...
> 由 **historical source-grounded workflow** 生成；**已应用户指示修订**：将现代政治立场从「激进革命派」收敛为「最终目标超越资本主义、现阶段依靠合法政治手段（议会斗争+和平街头）的急进左翼改革派（非立刻革命/非暴力）」。`meta.user_modified_after_generation = true`，旧 review 已失效，本次为修订后重审。
> 用户确认前不得激活该 persona。
...
- Creative inference level: 气质结构为 `documented_behavior` / `repeated_pattern` / `strong_historical_inference`；现代政治立场（最终目标超越资本主义、现阶段依靠合法政治手段的急进左翼改革派；非立刻革命/非暴力）为 SPEC §5.3.1 推演（人格结构 × 现代社会情况），属 `speculative`，**非史实**；现代 hobbies、选区构成等为现代化创作。
...
- Support base: 工人、青年、被剥夺的普通劳动者；反资本公民改革派；党内急进左翼 / 年轻党员
- Ideology summary: 最终目标超越资本主义、现阶段依靠合法政治手段的急进左翼改革派——直指资本主义阶级结构这一根本矛盾，而非只治表层垄断；他判断当今社会条件尚不允许立刻超越资本主义（决策人格使然），故不寻求立刻革命、借用议会平台，以议会斗争为主、和平街头活动为辅；理想蓝图先行、向死而生、议会质询台上锋利破局。不是任何现成的革命标签。
- Ideology (6-axis): economy -62 / welfare +70 / institution -38 / foreign_policy +30 / social_values +70 / decentralization +12
...
- Stance formation logic: 把"对权威质疑、判定过时即果断打破"的人格底子放进这段经历——从小目睹的现象被他学到的理论解释为资本主义的结构性矛盾，由此确立最终目标超越资本主义；至于现阶段怎么走，是他的决策人格在起作用——他判断当今社会条件尚不允许立刻超越资本主义、立刻革命既不现实也注定失败（能用就用、判定此路当下不通就换路），所以现阶段借用议会平台、依靠合法政治手段（议会斗争 + 和平街头）积累力量。他的急进在于"对推进速度与彻底度不满、敢在合法框架内果断掀桌子"，而非否定合法政治或寻求暴力。看起来像反叛，但逻辑链条连贯，不是为反叛而反叛。
...
- Recognizability risk: safe_conversion。现代 runtime 传记（identity / life_texture / political_core）已删除历史指纹（具体战役 / 家臣名单 / 死亡方式 / 历史地理年号）；历史事件名（桶狭间 / 村木砦 / 足利义昭 / 本能寺等）仅保留在 source_provenance、inference_level 与 historical_source_report 中作为溯源证据，不进入现代 runtime 身份。现代立场为"最终目标超越资本主义、现阶段依靠合法政治手段的急进左翼改革派（非立刻革命/非暴力）"原型 + 信长气质结构，未含任何现实左翼人物的具体指纹（口号 / 遇刺 / 流亡 / 特定政策名 / 党派轨迹）；隐去姓名后不可识别为某近现代现实政治人物。
