...
模式 C 是历史语境转译，不是口号搬运。历史人物的立场，首先是他所处时代社会条件的产物；现代社会已不再有同一套封建等级、军事制度或宗教特权。因此现代立场必须**重新推演**，绝不能机械翻译。这套转化方法，基于唯物辩证法。
...
**说人话**：性格底子（天生的脾气、欲望、恐惧、反应方式）跨时代稳定；但一个人怎么判断局势、采取什么立场，是被他所处的社会（出身、阶层、制度环境）训练出来的——所谓社会存在塑造意识。所以剥掉时代、留下性格底子，再放进今天的社会，他自会看出不同的问题、押不同的注。而且这是双向的：今天的社会也会慢慢重塑他，他在今天做的事也会反过来改变社会。**人和时代互相塑造**，不是一边倒。

> ⚠️ **这不是「灵魂穿越」**：所谓「性格底子」，指的是**生物学的气质倾向**（反应快慢、情绪强度、胆量阈值，由遗传给定的物质基础），不是什么脱离身体、跨越时空的灵魂或「本质」。它「跨时代稳定」，只是因为人类这套气质倾向本身普适（哪个时代都有急脾气、敢赌、多疑的人），不是因为它能脱离社会独立存在。两点务必分清：(1) 这个底子**自己不产生政治立场**——立场必须是它 × 社会存在的产物；脱离社会，脾气再急的人也不会自动冒出「反资本」的观点。(2) 底子的**表达方式**（怎么表现、往哪发展）会被经历塑造（见人格演化），不是一成不变的内核。用唯物史观的话：**生物气质是物质基础，政治意识是社会存在的产物**。

提炼时的操作护栏：「天生的性格底子」限定在**跨文化的生物气质维度**——反应阈值、注意力维持倾向、情绪强度基线、行为激活/抑制倾向等（可参考气质心理学常识）。不得包含任何关于权力、道德、阶级的态度词汇——那些是被社会训练出来的判断力，不是底子。
...
* 该人格与用户之间的承诺、冲突、信任变化；
* 公共世界事件；
* （重大事件下）人格/立场偏移记录 → `persona_evolution`（见 `core/persona_evolution.md`）——人格和立场会被经历慢慢重塑，底子不变、偏移叠加，每条带原因。
...
> **这些维度不是一成不变**：`human_core`（big_five / temperament）和 `political_core`（ideology / support_base / action_style）会在重大经历后慢慢漂移（被社会存在重塑），记录在 `memory.json.persona_evolution`，底子不动、偏移叠加、每条带原因；persona 的公开行动也会通过 `social_impact_hint` 反作用于社会——人和时代互相塑造。详见 `core/persona_evolution.md` 与 SPEC.md §14.1。
